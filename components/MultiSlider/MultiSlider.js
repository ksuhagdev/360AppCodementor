...
import { StyleSheet, PanResponder, View, Platform, I18nManager } from 'react-native';
...
export default class MultiSlider extends React.Component {
  ...
  constructor(props) {
    ...
    const initialValues = this.props.values.map(value => valueToPosition(value, this.optionsArray, this.props.sliderLength));
        ...
        <View style={[styles.fullTrack, { width: sliderLength }]}>
          ...
          {twoMarkers && positionOne !== this.props.sliderLength && (
            <View style={[styles.markerContainer, markerContainerTwo, this.props.markerContainerStyle]}>
              <View style={[styles.touch, touchStyle]} ref={component => (this._markerTwo = component)} {...this._panResponderTwo.panHandlers}>
                {isMarkersSeparated === false ? (
                  <Marker
